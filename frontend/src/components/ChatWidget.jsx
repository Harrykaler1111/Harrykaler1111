      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed bottom-16 right-3 left-3 sm:left-auto sm:w-[340px] z-[9999] max-h-[60vh] bg-white rounded-2xl shadow-2xl flex flex-col overflow-hidden border border-neutral-200"
