        ...
        <div className="bg-neutral-900 border-b border-neutral-800">
          <div className="max-w-7xl mx-auto px-4 md:px-8 flex items-center justify-between h-8">
            <a href={whatsappLink()} target="_blank" rel="noopener noreferrer"
              className="flex items-center gap-1.5 text-[11px] text-neutral-400 hover:text-green-400 transition-colors"
            ...
            <a href={PHONE_LINK} className="flex items-center gap-1.5 text-[11px] text-neutral-400 hover:text-gold transition-colors" data-testid="header-phone-link">
